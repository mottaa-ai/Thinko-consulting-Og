      ...
      <main className="pt-24">
        ...
        <section className="py-32 px-8 md:px-24 bg-slate-950 scroll-mt-20">
          ...
          <div className="max-w-4xl">
            <span className="text-[5rem] font-light text-[#00b8b4]/20 block">01</span>
        ...
        <section className="py-24 px-8 md:px-24 bg-surface-container-low">
          <div className="max-w-5xl">
            <h3 className="font-headline text-2xl font-medium text-foreground mb-8">Metodologías Clave</h3>
